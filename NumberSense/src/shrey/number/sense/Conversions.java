...
public class Conversions extends Trick {
	@Override
	public String[] tL() {
		...
		/*
		 * integer a will be to select the type of measurement desired at
		 * random. 0 will be volume, 1 will be short length, and 2 will be long
		 * length
		 */
		int a = (int) (Math.random() * 3);
		/*
		 * integer b will signify amount of conversions in the selected type
		 * volume will have fl oz, cups, pints, quarts, gallons, pecks and
		 * bushels short length will have inches, feet, and yards long length
		 * will have rods, miles, and furlongs
		 */
		int b = 3;
		if (a == 0) {
			b = 7;
